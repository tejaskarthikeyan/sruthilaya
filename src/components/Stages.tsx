...
const Stages = () => {
  ...
  return (
    <section id="stages" className="py-20 bg-gradient-to-b from-background to-black-card relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <blockquote className="text-xl md:text-2xl text-gold italic font-medium mb-8 max-w-4xl mx-auto">
